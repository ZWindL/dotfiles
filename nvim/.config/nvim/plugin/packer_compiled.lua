...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    config = { 'require("plugconfs/comment")' },
    loaded = true,
    path = "/home/zwindl/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["bufferline.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/zwindl/.local/share/nvim/site/pack/packer/opt/bufferline.nvim",
  ...
  ["dim.lua"] = {
    ...
    loaded = true,
    path = "/home/zwindl/.local/share/nvim/site/pack/packer/start/dim.lua",
  ...
  ["git-messenger.vim"] = {
    loaded = true,
    path = "/home/zwindl/.local/share/nvim/site/pack/packer/start/git-messenger.vim",
  ...
  ["lualine-lsp-progress"] = {
    loaded = true,
    path = "/home/zwindl/.local/share/nvim/site/pack/packer/start/lualine-lsp-progress",
  ...
  ["nvim-luadev"] = {
    loaded = true,
    path = "/home/zwindl/.local/share/nvim/site/pack/packer/start/nvim-luadev",
  ...
  ["nvim-ufo"] = {
    loaded = true,
    path = "/home/zwindl/.local/share/nvim/site/pack/packer/start/nvim-ufo",
  ...
  ["promise-async"] = {
    loaded = true,
    path = "/home/zwindl/.local/share/nvim/site/pack/packer/start/promise-async",
  ...
  ["vim-repeat"] = {
    loaded = true,
    path = "/home/zwindl/.local/share/nvim/site/pack/packer/start/vim-repeat",
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'bufferline.nvim', 'gitsigns.nvim', 'lightspeed.nvim', 'nvim-colorizer.lua'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
