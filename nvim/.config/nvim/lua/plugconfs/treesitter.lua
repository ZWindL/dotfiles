require"nvim-treesitter.configs".setup {
    ensure_installed = {
        ...
        "fish", "go", "gomod", "graphql", "haskell", "hcl", "help", "html",
        "http", "java", "javascript", "json", "json5", "jsonc", "julia",
        "kotlin", "latex", "llvm", "lua", "make", "markdown", "ninja", "nix",
        "ocaml", "ocamllex", "pascal", "perl", "php", "phpdoc", "python",
        "query", "r", "regex", "rst", "ruby", "rust", "scala", "scheme", "scss",
        "swift", "toml", "typescript", "vala", "verilog", "vim", "vue", "yaml"
    },
